...
const conexion = require('../models/Fragmento'); // Módulo Fragmento, necesario para el acceso a la base de datos
...
class MesaElectoral {
    ...
    extraerVotos(idParticipantes) {
        ...
        const votosReales = []
        conexion.obtenerFragmentos(idParticipantes).then(result => {
...
mesa.validarParticipante(llave1, 'ME1')
mesa.validarParticipante(llave2, 'ME2')
mesa.validarParticipante(llave3, 'ME3')
